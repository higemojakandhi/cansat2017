...
NineAxis::NineAxis(int pinInterrupt){
...
void NineAxis::init(){
  ...
  digitalWrite(_pinInterrupt, LOW);
  ...
  Serial.print(F("MPU9250 ")); Serial.print(F("I AM ")); Serial.print(c, HEX); Serial.print(" I should be "); Serial.println(0x71, HEX);
  delay(800);
...
void NineAxis::readMagData(int16_t * destination)
{
...
void NineAxis::initAK8963(float * destination)
{
...
void NineAxis::magcalMPU9250(float * dest1, float * dest2)
{
...
void NineAxis::calibrateMPU9250(float * dest1, float * dest2)
{
...
void NineAxis::MadgwickQuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
{
...
void NineAxis::MPU9250SelfTest(float * destination) // Should return percent deviation from factory trim values, +/- 14 or less deviation is a pass
{
...
void NineAxis::writeByte(uint8_t address, uint8_t subAddress, uint8_t data){
...
uint8_t NineAxis::readByte(uint8_t address, uint8_t subAddress){
